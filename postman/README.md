...
http://localhost:8034/swagger** (ASP.NET Core la genera con Swashbuckle).
...
La colección usa la variable `base` = `http://localhost:8034` (el proyecto
del curso). Si está probando **SU reconstrucción** (la de la
[GUIA_IA](../docs/spec_kit/versiones/v3_resto_entidades/GUIA_IA3.md), que corre en el puerto 8134): clic en la
colección → pestaña **Variables** → cambie `base` a
`http://localhost:8134`. Una sola edición y las 41 peticiones apuntan a su
proyecto.
