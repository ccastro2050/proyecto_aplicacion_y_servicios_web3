...
> **Versión 3** · La BD está completa desde la v1 (`db/bdfacturas.sql` —
...
| `cliente` | id INT **IDENTITY** · credito DECIMAL(18,2) DEFAULT 0 · fkcodpersona → persona **NOT NULL** · fkcodempresa → empresa **NULL** | 4 (ids 1, 2, 3 y 5 — el 4 no existe a propósito) |
| `vendedor` | id INT **IDENTITY** · carnet INT · direccion NVARCHAR(100) · fkcodpersona → persona | 3 (ids 1-3) |
| `rol` | id INT **IDENTITY** · nombre NVARCHAR(50) | 5 (Administrador, Vendedor, Cajero, Contador, Cliente) |
| `ruta` | id INT **IDENTITY** · ruta NVARCHAR(100) **UNIQUE** · descripcion NVARCHAR(200) | 15 (/home, /usuario, /factura…) |
