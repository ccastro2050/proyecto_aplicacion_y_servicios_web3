...
`db/bdfacturas.sql` desde el principio, con datos semilla.
...
2. **Copie las specs** desde el clon del curso (ajuste la primera ruta):
   ...
   ```powershell
   Copy-Item ..\proyecto_aplicacion_y_servicios_web3\docs\spec_kit\versiones\v3_resto_entidades\* docs\spec_kit\versiones\v3_resto_entidades\
   ```
