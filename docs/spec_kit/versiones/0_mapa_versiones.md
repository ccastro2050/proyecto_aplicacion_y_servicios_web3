...
| **v3** | **El resto de las entidades** contra SQL Server: empresa, cliente, vendedor, usuario (contraseña con **BCrypt** + verificar-contrasena), rol, ruta y las tablas puente rol_usuario y rutarol — TODA la bdfacturas cubierta con UN motor antes de cambiar de motor | **En curso** ([spec](v3_resto_entidades/2_spec.md)) |
