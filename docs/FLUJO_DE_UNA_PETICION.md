...
Invoke-RestMethod "http://localhost:8034/api/producto"
Invoke-RestMethod "http://localhost:8034/api/producto/PR001"

# POST — crear
Invoke-RestMethod -Method Post -Uri "http://localhost:8034/api/producto" -ContentType "application/json" -Body '{"codigo":"PR009","nombre":"Webcam","stock":10,"valorunitario":350000}'

# PUT con body incompleto → error 422 (PUT exige TODO)
Invoke-RestMethod -Method Put -Uri "http://localhost:8034/api/producto/PR009" -ContentType "application/json" -Body '{"stock":25}'

# PATCH con el MISMO body → 200 (PATCH es parcial)
Invoke-RestMethod -Method Patch -Uri "http://localhost:8034/api/producto/PR009" -ContentType "application/json" -Body '{"stock":25}'

# DELETE — limpiar
Invoke-RestMethod -Method Delete -Uri "http://localhost:8034/api/producto/PR009"
```
