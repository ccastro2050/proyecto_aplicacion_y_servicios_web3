...
este curso usted lo vive: la [GUIA_IA.md de la versión en curso](spec_kit/versiones/v2_persona_factura/GUIA_IA.md) construye la versión
...
3. En este repositorio: el [spec kit completo](spec_kit/1_constitution.md)
   y la [GUIA_IA.md de la versión en curso](spec_kit/versiones/v2_persona_factura/GUIA_IA.md) que lo pone a prueba.
