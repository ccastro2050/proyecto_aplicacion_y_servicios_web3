...
> [README](../README.md)). SQL Server queda publicado en `localhost,11465`.
...
| Port | `11465` | El puerto del host del compose (`11465:1433`) |
...
> El puerto es la clave: **11465, no 1433**. Dentro de la red de Docker
> la BD escucha en 1433, pero hacia su PC el compose la publica en 11465
...
>
> ```
> Error opening connection Failed to connect to localhost:11465
...
> (`http://localhost:8034/api/producto/PR009`) — un solo dato, muchos
> clientes.
...
| 1 | Crear la conexión (localhost,11465) con test y guardarla |
