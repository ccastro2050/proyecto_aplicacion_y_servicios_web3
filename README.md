...
> el puerto 8034 (pasa al reiniciar el PC: la API vieja revive sin su
...
> ```
> NAMES                                                 STATUS                    PORTS
> proyecto_aplicacion_y_servicios_web3-api-facturas-1   Up 2 hours                0.0.0.0:8034->8034/tcp
> proyecto_aplicacion_y_servicios_web3-sqlserver-1      Up 2 hours (healthy)      0.0.0.0:11465->1433/tcp
> ```
>
...
│   ├── Repositorios/            # Capa 3 — datos: Dapper (SQL a mano); el de factura (v2) llama
